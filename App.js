...
import {addTitle, coordinateDistanceRange, db, find, g, Itinerary, menuOpen, modal, relativePath, sort, sortByProperty} from './utils.js';
...
import Thumb from './pages/thumb.js';
...
const routes = [
	...
	{ path:'/account', component: Account, meta:{title:Account.meta.title} },
	...
	{ path:'/login', component: Login, meta:{title: Login.meta.title} },
	{ path:'/signup', component: Signup, meta:{title: Signup.meta.title} },
	{ path:'/pricing', component: Pricing, meta:{title: Pricing.meta.title} },
...
const app = Vue.createApp({
	...
	<div :class="splashPage" style="width:100%;">
		...
		<div id="content">
			...
			<router-view :universalBus="universalBus" :user="user" @user-updated="setUser"></router-view>
